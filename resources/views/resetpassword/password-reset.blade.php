      ...
      <div class="row">
        <div class="col-md-12 login-form">
            <div class="login_form_in">
              ...
              <form action="/updateresetpassword" method="POST">@csrf
              
                <input type="hidden" value="{{$email}}" name="useremail">
                <input type="hidden" value="{{$token}}" name="usertoken">
                <div class="form-group">
                  <input type="password" class="form-control" name="newpassword" placeholder="Enter New Password">
                </div>
                <!-- <div class="form-group">
                    <input type="password" class="form-control" name="newpassword" placeholder="Confirm New Password">
                  </div> -->
                <div class="form-group">
                  <button type="submit" class="btn btn-primary btn-sm btn-block">Reset Password</button>
                </div>
              </form>
            </div>
        </div>       
